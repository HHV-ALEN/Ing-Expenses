...
$sql_query = "SELECT viaticos.*, usuarios.Nombre AS nombre_usuario
FROM viaticos
INNER JOIN 
usuarios ON viaticos.Id_Usuario = usuarios.Id Order by viaticos.Id DESC
            ...
            <div class="col-md-12">
                <div class="card card-custom">
                    <div class="card-header card-header-custom">
                        <h4 class="text-center">Listado de Viáticos</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th style="text-align:center">Nombre de Solicitante</th>
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td style='text-align:center'>" . $row['Fecha_Solicitud'] . "</td>";
                                            echo "<td style='text-align:center'>" . $row['Fecha_Salida'] . "</td>";
                                            echo "<td style='text-align:center'>" . $row['Fecha_Regreso'] . "</td>";
                                            echo "<td style='text-align:center'>" . $row['Estado'] . "</td>";
                                            if ($row['Estado'] == 'Abierto') {
                                                echo "<td style='text-align:center'><a href='detalles.php?id_viatico=" . $row['Id'] . "' class='btn btn-info'>Ver Información</a></td>";
                                                echo "<td style='text-align:center'><a href='editar.php?id_viatico=" . $row['Id'] . "' class='btn btn-warning'>Editar Información</a></td>";
                                            } elseif ($row['Estado'] == 'EnEspera') {
                                                echo "<td style='text-align:center' colspan='2'><a href='../Control/detallesEvidencias.php?id_viatico=" . $row['Id'] . "' class='btn btn-outline-success'>Verificar Evidencias</a></td>";
                                            ...
                                            elseif($row['Estado'] == 'Comprobación') {

                                                echo "<td style='text-align:center' colspan='2'><a href='detalles.php?id_viatico=" . $row['Id'] . "' class='btn btn-info'>Ver Información</a></td>";
                                                echo "<td style='text-align:center' colspan='2'><a href='../Control/detallesEvidencias.php?id_viatico=" . $row['Id'] . "' class='btn btn-outline-success'>Comprobar Evidencias</a></td>";
                                            }
                                            elseif ($row['Estado'] == 'Prórroga') {
                                                echo "<td style='text-align:center' colspan='2'><a href='detalles.php?id_viatico=" . $row['Id'] . "' class='btn btn-info'>Ver Información</a></td>";
                                                echo "<td style='text-align:center' colspan='2'><a href='../Control/detallesEvidencias.php?id_viatico=" . $row['Id'] . "' class='btn btn-outline-success'>Comprobar Evidencias</a></td>";
                                            }   
                                            elseif ($row['Estado'] == 'Segunda Revisión'){
                                                echo "<td style='text-align:center' colspan='2'><a href='detalles.php?id_viatico=" . $row['Id'] . "' class='btn btn-info'>Ver Información</a></td>";
                                                echo "<td style='text-align:center' colspan='2'><a href='../Control/detallesEvidencias.php?id_viatico=" . $row['Id'] . "' class='btn btn-outline-success'>Comprobar Evidencias</a></td>";
                                            }
