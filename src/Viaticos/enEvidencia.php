...
$sql_query = "SELECT viaticos.*, usuarios.Nombre
FROM viaticos
INNER JOIN usuarios ON viaticos.Id_Usuario = usuarios.Id
WHERE viaticos.Estado = 'Comprobación' AND viaticos.Id_Gerente = '$id_user'
...
<head>
    ...
    <title>Listado de evidencias a mi cargo</title>
            ...
            <div class="col-md-12">
                <div class="card card-custom">
                    <div class="card-header card-header-custom">
                        <h4 class="text-center">Listado de Evidencias</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td style='text-align:center' colspan='2'><a href='../Control/detallesEvidencias.php?id_viatico=" . $row['Id'] . "' class='btn btn-success'>Verificar Evidencias</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
