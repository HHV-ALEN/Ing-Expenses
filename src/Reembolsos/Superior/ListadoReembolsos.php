...
$sql_query = "SELECT * FROM reembolsos WHERE 1"; // "1" para asegurarse de que siempre tenga una condición
...
$total_records_query = "SELECT COUNT(*) AS total_registros FROM reembolsos WHERE 1";
...
<head>
    ...
    <title>Listado Reembolsos</title>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header card-header-custom">
                        <h5 class="card-title text-center"><i class="fas fa-user"></i> Reembolsos Registrados </h5>
                    </div>
                    <div class="card-body">
