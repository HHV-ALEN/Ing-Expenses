...
echo "ID Reembolso: " . $id_reembolsos . "<br>";
echo "------------------------------------- <br>";
...
try {
    ...
    $mail->setFrom('alenstore@alenintelligent.com', 'Reembolso Rechazado');
    $mail->addAddress($CorreoGerente, $NombreGerente);
    $mail->isHTML(true);
    $mail->CharSet = 'UTF-8';
    $mail->Subject = 'El Reembolso de ' . $NombreUsuario . ' ha sido Rechazado';
    $mail->Body = '
        <p>Estimado/a ' . $NombreGerente . ',</p>

        <p>Se ha Rechazado la solicitud de: ' . $NombreUsuario . ' con id ' . $Id . '</p>
    ...
    $mail->AltBody = 'La solicitud de ' . $NombreUsuario . ' ha sido Rechazada:
    <strong>Monto:</strong> ' . $Monto . '<br>
            <strong>Descripción:</strong> ' . $Descripcion . '<br>
            <strong>Concepto:</strong> ' . $Concepto . '<br>
    ...
    $mail->Subject = 'Tú Solicitud de Reembolso ha sido Rechazada';
    $mail->Body = '
        <p>Estimado/a ' . $NombreUsuario . ',</p>

        <p>Se ha Rechazado la solicitud de reembolso (' . $Id . ')</p>
        <hr>
        <p><strong>Información de la solicitud de reembolso:</strong></p>
        <p>
            <strong>Monto:</strong> ' . $Monto . '<br>
    ...
    $mail->AltBody = '' . $NombreUsuario . ' ha Rechazado un reembolso por los siguientes gastos realizados durante su viaje:
    <strong>Monto:</strong> ' . $Monto . '<br>
            <strong>Descripción:</strong> ' . $Descripcion . '<br>
            <strong>Concepto:</strong> ' . $Concepto . '<br>
    Para más detalles y seguimiento de la solicitud, acceda al aplicativo.';
