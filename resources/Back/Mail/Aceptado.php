...
try {
    ...
    <p>Buenas noticias: La solicitud de viáticos de ' . $NombreUsuario . ' ha sido aceptada.</p>
    ...
    $mail->AltBody = 'La solicitud de viáticos de ' . $NombreUsuario . ' ha sido aceptada: 
    ...
    $mail->addAddress($CorreoUsuario, $NombreUsuario);
    $mail->Subject = 'Buenas Noticias ' . $NombreUsuario . ': Solicitud Aceptada';
    $mail->Body = '
    <p>Estimado/a ' . $NombreUsuario . ',</p>

    <p>Tenemos buenas noticias: tu solicitud de viáticos ha sido aceptada.</p>
    ...
    <p>Una vez completado tu viaje, no olvides subir tus comprobantes de gastos.</p>
    
    <p>Tienes 3 días para completar la verificación de tu viático.</p>
    ...
    $mail->AltBody = 'Tu solicitud de viáticos ha sido aceptada: 
    Fecha de Salida: ' . $Fecha_Salida . '
    Hora de Salida: ' . $Hora_Salida . '
    Fecha de Regreso: ' . $Fecha_Regreso . '
    Hora de Regreso: ' . $Hora_Regreso . '
    ...
    Destino: ' . $Destino . '
    Monto Total Solicitado: ' . $Total . '
    Una vez completado tu viaje, no olvides subir tus comprobantes de gastos. Tienes 3 días para completar la verificación de tu viático. Para más detalles y seguimiento de tu solicitud, accede al aplicativo.';
