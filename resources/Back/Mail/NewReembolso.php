...
try {
    ...
    $mail->isHTML(true);
    $mail->CharSet = 'UTF-8';
    $mail->Subject = 'Nueva solicitud de Reembolso de ' . $Nombre_Solicitante;
    $mail->Body = '
    <p>Estimado ' . $NombreGerente . ',</p>

    <p>Se ha registrado una nueva solicitud de ' . $Nombre_Solicitante . ' para Reembolso con la siguiente información:</p>
